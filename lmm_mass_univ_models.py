...
for sync in syncs:
    for dur in durs:
        ...
        if do_stim_num:
            formula = "Brain ~ C(Index, Treatment('Pre'))".format(col, t_string)
            outfile = "{}main_fits_index_{}_{}_{}_{}_{}.pickle".format(proc_dir, baseline, model, osc, dur, sync)
        else:
            formula = "Brain ~ C({}, Treatment('{}'))".format(col,t_string)
            outfile = "{}main_fits_{}_{}_{}_{}_{}.pickle".format(proc_dir, baseline, model, osc, dur, sync)
