...
plt.suptitle("Spindle Peak on SO phase", fontsize=40)
axes["P"].axis("off")
axes["W"].axis("off")
axes["0"].set_title("Sham", fontsize=40)
axes["1"].set_title("Eigen frequency", fontsize=40)
axes["2"].set_title("Fixed frequency", fontsize=40)
plt.tight_layout()
